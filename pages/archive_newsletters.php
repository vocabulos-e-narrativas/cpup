...
<body>
    <div class="container ">
        ...
        <div class="row mt-4 mt-md-5">
            ...
            <div class="order-md-4 order-2 col-12 col-md-3 text-center text-md-center my-1 my-md-0">
                <a href="<?php echo BASE_URL; ?>pages/archive_newsletters.php" class="text-light-black">
                    <h3 class="medium pointer"><span class="border-bottom-light-black">NEWSLETTERS</span></h3>
                </a>
            </div>
                ...
                <div class="row">
                    <div class="col-9 col-md-11 text-center">
                        <div class="search-container pb-1">
                            <input class="w-100" type="text" id="searchInput" placeholder="SEARCH NEWSLETTERS"
                                oninput="searchContentNewsletters()">
    ...
    <div class="py-5 container">
        <div class="row pb-3 min-content">
            <div class="">
                <div class="row pb-3">
                    <?php
                    $csvData = file_get_contents('../cpup - Newsletter.csv');
                    $lines = explode("\n", $csvData);
                    ...
                    foreach (array_reverse($data) as $cpupnewsletter) {
                        echo '
                            <div id="' . $cpupnewsletter['id'] . '_content' . '" class="col-md-3 archive-item" data-date="' . $cpupnewsletter['start_date'] . '">
                                <img src="' . BASE_URL . 'images/newsletter/' . $cpupnewsletter['photo'] . '" alt="" class="w-100 my-3 border-radius-10">
                            </div>
                        ';
                    }
                    ?>
    ...
    <script src="<?php echo BASE_URL; ?>js/archive/searchContentNewsletters.js"></script>
