...
<body>
    <div class="container ">
        ...
        <div class="row mt-4 mt-md-5">
            ...
            <div class="order-md-2 order-5 col-12 col-md-1 text-center text-md-center my-1 my-md-0">
                <a href="<?php echo BASE_URL; ?>pages/archive_news.php" class="text-light-black">
                    <h3 class="medium pointer"><span class="border-bottom-light-black">NEWS</span></h3>
                </a>
            </div>
                ...
                <div class="row">
                    <div class="col-9 col-md-11 text-center">
                        <div class="search-container pb-1">
                            <input class="w-100" type="text" id="searchInput" placeholder="SEARCH NEWS"
                                oninput="searchContentNews()">
            ...
            <div class="">
                <div class="row pb-3">
                    ...
                    foreach (array_reverse($data) as $cpupnews) {
                        echo '
                        <div id="' . $cpupnews['id'] . '_content' . '" class="my-2 col-md-3 archive-item archive-item-visible" data-date="' . $cpupnews['start_date'] . '">
                            <img src="' . BASE_URL . 'images/news/' . $cpupnews['photo'] . '" alt="" class="w-100 my-3 border-radius-10">
                            <h5 class="medium">' . $cpupnews['title'] . '</h5>
                            <p>' . $cpupnews['description'] . '</p>
                        </div>
                        ';
                    }
                    ?>
    ...
    <script src="<?php echo BASE_URL; ?>js/archive/searchContentNews.js"></script>
