...
<body>
    <div class="container">
        <div id="de" class="row py-3 pb-5 px-5">
            <div class="col-md-5">
                <div class="text-light-black bg-light-gray border-radius-20 px-5 py-4">
                    <p>
                        The Development and Education Research Group implements evidence-based school and family
                        interventions targeting the development, learning, and the well-being of children and
                        adolescents.
                    </p>
                    <p class="medium text-dark-cian py-3">
                        Research Topics: typical and deviant development; parenting; educational processes and
                        environment; child rights and protection
                    </p>
                    <a href="https://sigarra.up.pt/fpceup/en/uni_geral.unidade_view?pv_unidade=75" target="_blank"
                        class="text-light-black">
                        <p>Center for Educational Psychology (U.Porto)</p>
                    </a>
                </div>
            </div>
            <div class="col-md-7">
                <div class="specific-group-wrapper bg-dark-cian">
                    <h1 class="text-white">
                        Development <br />
                        and Education<br />
                        Research Group
        ...
        <div class="container about-team-container text-white">
            <div id="integrated_members_content">
                <div class="row">
                    ...
                    foreach ($about as $member) {
                        if (($member['research_group'] === 'de') && ($member['research_group_where'] === 'integrated_members')) {
            ...
            <div id="colaborators_content" style="display: none">
                <div class="row">
                    ...
                    // Filtra e armazena membros em um array
                    foreach ($about as $member) {
                        if (($member['research_group'] === 'de') && ($member['research_group_where'] === 'collaborators')) {
            ...
            <div id="phd_students_content" style="display: none">
                <div class="row">
                    ...
                    // Filtra e armazena membros em um array
                    foreach ($about as $member) {
                        if (($member['research_group'] === 'de') && ($member['research_group_where'] === 'phd_students')) {
                            $phdStudents[] = $member;
                            $membersCount++;
                        }
                    }
    ...
    <div class="container p-5">
        ...
        foreach ($projects as $project) {
            if ($project['research_group'] == 'de') {
                ?>
                <div class="accordion py-2" id="accordionExample_<?php echo $project['id']; ?>">
                    <div class="accordion-item">
                        <h2 class="accordion-header accordion-header-wrapper accordion-header-border-dark-cian border-radius-15"
                        ...
                        <div id="collapse_<?php echo $project['id']; ?>"
                            class="accordion-collapse accordion-collapse-border-dark-cian collapse bg-dark-cian border-radius-15 text-white"
