...
<body>
    <div class="container ">
        ...
        <div class="row mt-4 mt-md-5">
            ...
            <div class="order-md-3 order-4 col-12 col-md-3 text-center text-md-end my-1 my-md-0">
                <a href="<?php echo BASE_URL; ?>pages/archive_publications.php">
                    <h3 class="medium pointer text-gray"><span class="">PUBLICATIONS</span></h3>
                </a>
            </div>
            ...
            <div class="order-md-5 order-3 col-12 col-md-3 text-center text-md-end my-1 my-md-0">
                <a href="<?php echo BASE_URL; ?>pages/archive_media.php" class="text-light-black">
                    <h3 class="medium pointer"><span class="border-bottom-light-black">CPUP IN THE MEDIA</span></h3>
                </a>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-9 col-md-11 text-center">
                        <div class="search-container pb-1">
                            <input class="w-100" type="text" id="searchInput" placeholder="SEARCH CPUP IN THE MEDIA"
                                oninput="searchContentMedia()">
    ...
    <div class="py-5 container">
        <div class="row pb-3 min-content">
            <div class="">
                <div class="row pb-5">
                    <?php
                    $csvData = file_get_contents('../cpup - Media.csv');
                    $lines = explode("\n", $csvData);
                    ...
                    foreach (array_reverse($data) as $cpupmedia) {
                        echo '
                            <div id="' . $cpupmedia['id'] . '_content' . '" class="h-100 my-2 my-md-0 col-12 col-md-5-6 bg-light-gray border-radius-10 mx-1" data-date="' . $cpupmedia['start_date'] . '">
                                <div class="row py-2">
                                    <div class="col-md-6">
                                        <img src="' . BASE_URL . 'images/media/' . $cpupmedia['photo'] . '" alt="" class="w-100 border-radius-10">
                                    </div>
                                    <div class="col-md-6">
                                        <h5 class="medium py-2 text-light-black">' . $cpupmedia['description'] . '</h5>
                                    </div>
                                </div>
                            </div>
                        ';
    ...
    <script src="<?php echo BASE_URL; ?>js/archive/searchContentMedia.js"></script>
