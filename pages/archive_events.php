...
<body>
    <div class="container ">
        ...
        <div class="row mt-4 mt-md-5">
            <div class="order-md-1 order-1 col-12 col-md-2 text-center text-md-start my-1 my-md-0">
                <a href="<?php echo BASE_URL; ?>pages/archive_events.php" class="text-light-black">
                    <h3 class="medium pointer"><span class="border-bottom-light-black">EVENTS</span></h3>
                </a>
            </div>
                ...
                <div class="row">
                    <div class="col-9 col-md-11 text-center">
                        <div class="search-container pb-1">
                            <input class="w-100" type="text" id="searchInput" placeholder="SEARCH EVENTS"
                                oninput="searchContentEvents()">
        ...
        <div class="row pb-3 min-content">
            <div class="">
                <div class="row pb-3">
                    ...
                    foreach (array_reverse($data) as $cpupevent) {
                        echo '
                        <div id="' . $cpupevent['id'] . '_content' . '" class="col-md-3 archive-item archive-item-visible" data-date="' . $cpupevent['start_date'] . '">
                            <img src="' . BASE_URL . 'images/event/' . $cpupevent['photo'] . '" alt="" class="w-100 my-3 border-radius-10">
                            <h5 class="medium">' . $cpupevent['title'] . '</h5>
                            <p>' . $cpupevent['description'] . '</+>
                            <p>' . formatarData($cpupevent['start_date']) . '</+>
                        </div>
                        ';
                    }
                    ?>
    ...
    <script src="<?php echo BASE_URL; ?>js/archive/searchContentEvents.js"></script>
