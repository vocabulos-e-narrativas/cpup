...
<body>
    <div class="container">
        <div id="hs" class="row py-3 pb-5 px-5">
            <div class="col-md-5">
                <div class="text-light-black bg-light-gray border-radius-20 px-5 py-4">
                    <p>
                        The Human Sexuality Research group develops basic and applied research to inform evidence-based
                        interventions and promote sexual health and sexual rights.
                    </p>
                    <p class="medium text-red py-3">
                        Research Topics: sexual health and well-being; basic processes and sexuality; sexual violence
                        and sexual diversity
                    </p>
                    <a href="https://sexlab.fpce.up.pt/" target="_blank" class="text-light-black">
                        <p>SexLab (U.Porto)</p>
                    </a>
                </div>
            </div>
            <div class="col-md-7">
                <div class="specific-group-wrapper bg-red">
                    <h1 class="text-white">
                        Human<br />
                        Sexuality<br />
                        Research Group
        ...
        <div class="container about-team-container text-white">
            <div id="integrated_members_content">
                <div class="row">
                    ...
                    foreach ($about as $member) {
                        if (($member['research_group'] === 'hs') && ($member['research_group_where'] === 'integrated_members')) {
            ...
            <div id="colaborators_content" style="display: none">
                <div class="row">
                    ...
                    // Filtra e armazena membros em um array
                    foreach ($about as $member) {
                        if (($member['research_group'] === 'hs') && ($member['research_group_where'] === 'collaborators')) {
            ...
            <div id="phd_students_content" style="display: none">
                <div class="row">
                    ...
                    // Filtra e armazena membros em um array
                    foreach ($about as $member) {
                        if (($member['research_group'] === 'hs') && ($member['research_group_where'] === 'phd_students')) {
                            $phdStudents[] = $member;
                            $membersCount++;
                        }
                    }
    ...
    <div class="container p-5">
        ...
        foreach ($projects as $project) {
            if ($project['research_group'] == 'hs') {
                ?>
                <div class="accordion py-2" id="accordionExample_<?php echo $project['id']; ?>">
                    <div class="accordion-item">
                        <h2 class="accordion-header accordion-header-wrapper accordion-header-border-red border-radius-15"
                        ...
                        <div id="collapse_<?php echo $project['id']; ?>"
                            class="accordion-collapse accordion-collapse-border-red collapse bg-red border-radius-15 text-white"
