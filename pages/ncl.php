...
<body>
    <div class="container">
        <div id="ncl" class="row py-3 pb-5 px-5">
            <div class="col-md-5">
                <div class="text-light-black bg-light-gray border-radius-20 px-5 py-4">
                    <p>
                        The Neurocognition and Language Research Group studies language, learning, and cognitive
                        processes by employing behavioral and neuroscientific methods. </p>
                    <p class="medium text-blood py-3">
                        Research Topics: complex neurocognitive systems; language, communication, and emotion; cognitive
                        plasticity and learning</p>
                    <a href="https://sigarra.up.pt/fpceup/pt/web_base.gera_pagina?p_pagina=NCL_HOME" target="_blank"
                        class="text-light-black">
                        <p>Speech Lab (U.Porto)</p>
                    </a>
                </div>
            </div>
            <div class="col-md-7">
                <div class="specific-group-wrapper bg-blood">
                    <h1 class="text-white">
                        Neurocognition<br />
                        and Language<br />
                        Research Group
        ...
        <div class="container about-team-container text-white">
            <div id="integrated_members_content">
                <div class="row">
                    ...
                    foreach ($about as $member) {
                        if (($member['research_group'] === 'ncl') && ($member['research_group_where'] === 'integrated_members')) {
                        ...
                        <div class="row pb-0 pb-md-5 px-5">
                            ...
                            if ($i == 0) {
                                ...
                                <div class="col-md-4">
                                    <div class="row d-flex align-items-center">
                                        <p class="text-white" onclick="AboutTeam_handleClick(1)"><img
                                                id="integrated_members_trigger"
                                                src="<?php echo BASE_URL; ?>images/about/active_ball.svg" class="mb-1"
                                                alt="active_ball.svg"> Integrated Members</p>
                                    </div>
                                    <div class="row d-flex align-items-center">
                            ...
                            foreach ($integratedMembers as $key => $member) {
                                ...
                                <div class="col-6 col-md-2 my-2 my-md-0 text-center text-white">
                                    <div class="row">
                                        <img src="<?php echo BASE_URL; ?>images/people/<?php echo $member['photo']; ?>.png"
                                            alt="" class="w-75 mx-auto circle-image">
                                    </div>
                                    <div class="row my-1">
                                        <span class="medium">
            ...
            <div id="colaborators_content" style="display: none">
                <div class="row">
                    ...
                    // Filtra e armazena membros em um array
                    foreach ($about as $member) {
                        if (($member['research_group'] === 'ncl') && ($member['research_group_where'] === 'collaborators')) {
                        ...
                        <div class="row pb-0 pb-md-5 px-5">
                            ...
                            if ($i == 0) {
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="row d-flex align-items-center">
                                        <p class="text-white" onclick="AboutTeam_handleClick(2)"><img id="colaborators_trigger"
                                                src="<?php echo BASE_URL; ?>images/about/active_ball.svg" class="mb-1"
                                                alt="active_ball.svg"> Collaborators</p>
                                    </div>
                                    <div class="row d-flex align-items-center">
                                        <p class="text-gray" onclick="AboutTeam_handleClick(3)">
                                            <img id="phd_students_trigger"
            ...
            <div id="phd_students_content" style="display: none">
                <div class="row">
                    ...
                    // Filtra e armazena membros em um array
                    foreach ($about as $member) {
                        if (($member['research_group'] === 'ncl') && ($member['research_group_where'] === 'phd_students')) {
                            $phdStudents[] = $member;
                            $membersCount++;
                        }
                    }
                        ...
                        <div class="row pb-0 pb-md-5 px-5">
                            ...
                            if ($i == 0) {
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="row d-flex align-items-center">
                                        <p class="text-white" onclick="AboutTeam_handleClick(3)"><img id="phd_students_trigger"
                                                src="<?php echo BASE_URL; ?>images/about/active_ball.svg" class="mb-1"
                                                alt="active_ball.svg"> PhD Students</p>
                                    </div>
                                </div>
                                <?php
                            }
    ...
    <div class="container p-5">
        ...
        foreach ($projects as $project) {
            if ($project['research_group'] == 'ncl') {
                ?>
                <div class="accordion py-2" id="accordionExample_<?php echo $project['id']; ?>">
                    <div class="accordion-item">
                        <h2 class="accordion-header accordion-header-wrapper accordion-header-border-blood border-radius-15"
                        ...
                        <div id="collapse_<?php echo $project['id']; ?>"
                            class="accordion-collapse accordion-collapse-border-blood collapse bg-blood border-radius-15 text-white"
