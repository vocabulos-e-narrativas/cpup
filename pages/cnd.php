...
<body>
    <div class="container">
        <div id="cnd" class="row py-3 pb-5 px-5">
            <div class="col-md-5">
                <div class="text-light-black bg-light-gray border-radius-20 px-5 py-4">
                    <p>
                        The Culture, Normativity, and Diversity Research Group analyzes
                        the social challenges faced by demographic groups and their specific contexts.
                    </p>
                    <p class="medium text-purple py-3">
                        Research Topics: Gender equality; Discrimination and prejudice; Social minorities;
                        Work-family balance; Work psychology
                    </p>
                    <a href="https://sigarra.up.pt/fpceup/en/uni_geral.unidade_view?pv_unidade=410" target="_blank"
                        class="text-light-black">
                        <p>Laboratory of Social Psychology (U.Porto)</p>
                    </a>
                    <a href="https://sigarra.up.pt/fpceup/pt/uni_geral.unidade_view?pv_unidade=490" target="_blank"
                        class="text-light-black">
                        <p>Work Psychology Atelier (U.Porto)</p>
                    </a>
                </div>
            </div>
            <div class="col-md-7">
                <div class="specific-group-wrapper bg-purple">
                    <h1 class="text-white">
                        Culture,
                        Normativity<br />
                        and Diversity
        ...
        <div class="container about-team-container text-white">
            <div id="integrated_members_content">
                <div class="row">
                    ...
                    foreach ($about as $member) {
                        if (($member['research_group'] === "cnd") && ($member['research_group_where'] === "integrated_members")) {
            ...
            <div id="colaborators_content" style="display: none">
                <div class="row">
                    ...
                    // Filtra e armazena membros em um array
                    foreach ($about as $member) {
                        if (($member['research_group'] === 'cnd') && ($member['research_group_where'] === 'collaborators')) {
            ...
            <div id="phd_students_content" style="display: none">
                <div class="row">
                    ...
                    // Filtra e armazena membros em um array
                    foreach ($about as $member) {
                        if (($member['research_group'] === 'cnd') && ($member['research_group_where'] === 'phd_students')) {
                            $phdStudents[] = $member;
                            $membersCount++;
                        }
                    }
    ...
    <div class="container p-5">
        ...
        foreach ($projects as $project) {
            if ($project['research_group'] == 'cnd') {
                ?>
                <div class="accordion py-2" id="accordionExample_<?php echo $project['id']; ?>">
                    <div class="accordion-item">
                        <h2 class="accordion-header accordion-header-wrapper accordion-header-border-purple border-radius-15"
                        ...
                        <div id="collapse_<?php echo $project['id']; ?>"
                            class="accordion-collapse accordion-collapse-border-purple collapse bg-purple border-radius-15 text-white"
